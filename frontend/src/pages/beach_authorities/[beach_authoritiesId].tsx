...
const EditBeach_authorities = () => {
  ...
  const { beach_authoritiesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: beach_authoritiesId }));
  }, [beach_authoritiesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: beach_authoritiesId, data }));
...
EditBeach_authorities.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditBeach_authorities;
