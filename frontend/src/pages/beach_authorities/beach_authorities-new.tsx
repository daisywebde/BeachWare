...
import { create } from '../../stores/beach_authorities/beach_authoritiesSlice';
...
Beach_authoritiesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_BEACH_AUTHORITIES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Beach_authoritiesNew;
