...
const Dashboard = () => {
  ...
  const [beach_authorities, setBeach_authorities] =
    React.useState('Loading...');
  const [beaches, setBeaches] = React.useState('Loading...');
  ...
  const [beach_authority, setBeach_authority] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_BEACH_AUTHORITIES') && (
            <Link href={'/beach_authorities/beach_authorities-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
          ...
          {hasPermission(currentUser, 'READ_BEACHES') && (
            <Link href={'/beaches/beaches-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiBeach || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
          ...
          {hasPermission(currentUser, 'READ_BEACH_AUTHORITY') && (
            <Link href={'/beach_authority/beach_authority-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
