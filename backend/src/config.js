...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'a9032f8b3d4ba45916ad94f1e680363f',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Beachware <app@flatlogic.app>',
  ...
  project_uuid: '11bdf694-503a-4511-b61e-d91cd78d3a9d',
  flHost:
...
config.pexelsQuery = 'calm ocean waves at sunset';
config.host =
