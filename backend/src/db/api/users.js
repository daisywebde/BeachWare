...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setBeach_authority(data.data.beach_authority || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setBeach_authority(data.beach_authority || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.beach_authority = await users.getBeach_authority({
      transaction,
    });
